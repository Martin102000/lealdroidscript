...
funcao_idioma () {
 echo -e " "
msg -bar2
 "BIENVENIDO Y GRACIAS POR UTILIZAR EL SCRIPT. VENTAS LEALDROID" | lolcat
...
msg -bar2
msg -ama "[ SCRIPT PRIVADO ] ➣ \033[1;33m[\033[1;34m VENTAS LEALDROID \033[1;33m]"
[[ $1 = "" ]] && funcao_idioma || {
